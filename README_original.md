...
This file contains the **original README provided by the author of the tool**.

- The content below is preserved exactly as originally released
- No wording, formatting, or technical descriptions have been modified
- This document is included for reference and attribution purposes

For user-oriented explanations and Chinese documentation,
please refer to the main README.md in this repository.
